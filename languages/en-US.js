...
module.exports = class extends Language {
	constructor(...args) {
		super(...args);
		this.language = {
			DEFAULT: (key) => `${key} has not been localized (translated) for en-US yet.`,
      INHIBITOR_MISSING_BOT_PERMS: (missing) => `🚫 [**Missing Permissions**]: I don\'t have the **${missing}** permission.`,
      INHIBITOR_PERMISSIONS: `🚫 [**Invalid Permissions**]: You don\'t have permission to use this command.`,
      INHIBITOR_DISABLED: '🚫 Sorry, this command is currently disabled.',
      ...
      INVITE_CMD: 'You can invite me to your server with the link below!\n**https://toastybot.com/invite**',
			INVITE_CMD_DESCRIPTION: 'Sends the invite URL so that you can add me to your server.',
			SHARDS_CMD_DESCRIPTION: 'Sends stats on the bot\'s shards.',
			...
			DONATE_CMD_DESCRIPTION: 'Help support Toasty by donating!',
			CREDITS_CMD_DESCRIPTION: 'Shows the bot\'s credits.',

			// Pokemon Commands
			POKEMON_CMD_DESCRIPTION: 'Catch a pokemon!',
			POKEMON_CMD_EXTENDEDHELP: 'Lets you catch a random Pokemon every 3 hours and stores it in your virtual inventory.\nYou can trade pokemon with other players or keep it for yourself.',
			POKEMON_CMD_COOLDOWNMSG_1: 'you need to wait another',
			POKEMON_CMD_COOLDOWNMSG_2: 'before catching another pokemon.',
			POKEMON_CMD_CATCHFAILMSG: 'you failed to catch a pokemon 😢',
			POKEMON_CMD_CATCHMSG: 'you\'ve caught a',

			INVENTORY_CMD_DESCRIPTION: 'Shows your, or the mentioned user\'s pokemon inventory.',
			INVENTORY_CMD_DONTHAVE: 'you don\'t have any pokemon.',
			INVENTORY_CMD_DOESNTHAVE: 'that user doesn\'t have any pokemon.',
			INVENTORY_CMD_ONLINEMSG: 'View your inventory **[online]',
			...
			INVENTORY_CMD_INCLUDES: 'Includes',
